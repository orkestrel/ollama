...
| `OllamaErrorOptions`       | interface | `{ cause?: unknown }` — the options a thrown `OllamaHTTPError` accepts beside its message and status, carrying the underlying transport or body-read rejection.                                                                                                                                                                                               |
