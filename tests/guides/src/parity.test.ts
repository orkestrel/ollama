...
// checks against this repo's own `guides/README.md` manifest — one row (Ollama)
...
const SELF_SPECIFIERS = ['@src/server']
...
// Single-surface package — every fence import from `@src/server` resolves to
